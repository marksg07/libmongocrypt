...
mc_mincover_t* mc_getMincoverInt32(mc_getMincoverInt32_args_t args, mongocrypt_status_t* status) {
    ...
    if (!mc_getTypeInfo32(
            (mc_getTypeInfo32_args_t){.min = args.min, .max = args.max, .value = args.lowerBound},
            &a,
            status)) {
        return NULL;
    }
    if (!mc_getTypeInfo32(
            (mc_getTypeInfo32_args_t){.min = args.min, .max = args.max, .value = args.upperBound},
            &b,
            status)) {
        return NULL;
    }
...
mc_mincover_t* mc_getMincoverInt64(mc_getMincoverInt64_args_t args, mongocrypt_status_t* status) {
    ...
    if (!mc_getTypeInfo64(
            (mc_getTypeInfo64_args_t){.min = args.min, .max = args.max, .value = args.lowerBound},
            &a,
            status)) {
        return NULL;
    }
    if (!mc_getTypeInfo64(
            (mc_getTypeInfo64_args_t){.min = args.min, .max = args.max, .value = args.upperBound},
            &b,
            status)) {
        return NULL;
    }
